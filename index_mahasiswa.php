...
include "koneksi.php";
  ...
  $jumlah_absen=mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM mahasiswa"));
?>
...
<head>
  ...
  <title>Dashboard | POM UMBY</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="absensi1.php">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <span class="mr-2 d-none d-lg-inline text-gray-600 medium">Terakhir Masuk : <span class="text-success"><?=$admin_last_login?></span></span>
            </li>
        ...
        <div class="container-fluid">
          ...
          <div class="col-xl-3 col-md-6 mb-4 ">
              <div class="card border-left-success shadow h-100 py-2">
                 <a href="absensi1.php" style="text-decoration:none;">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Mahasiswa <br>Absen</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_absen?> (Absen)</div>
                    </div>
                    <div class="col-auto">
