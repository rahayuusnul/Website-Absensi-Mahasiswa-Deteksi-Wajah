<?php
  ...
  $admin_last_login = $_SESSION["admin_user_last_login"];
   ...
   $jumlah_mahasiswa=mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM faces"));
         ...
         <div class="col-xl-3 col-md-6 mb-4 ">
              ...
              <a href="absensi.php" style="text-decoration:none;">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Mahasiswa<br>Absen</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$jumlah_absen?> (Absensi)</div>
                    </div>
                    <div class="col-auto">
